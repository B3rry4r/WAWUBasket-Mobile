...
class MeatCutDesktopScreen extends ConsumerStatefulWidget {
  const MeatCutDesktopScreen({super.key, required this.productId});
  final String productId;

  @override
  ConsumerState<MeatCutDesktopScreen> createState() =>
      _MeatCutDesktopScreenState();
}

class _MeatCutDesktopScreenState extends ConsumerState<MeatCutDesktopScreen> {
  String _cut = 'pieces';
  double _weight = 2.0;
  bool _fresh = true;
