...
/// Desktop-web layout for a single recipe combo. Mirrors
/// [RecipeDetailScreen]'s data loading, size/match flow and add-to-basket
/// logic exactly, re-laid out as a two-column detail: media on the left,
/// info + sizes + ingredients + buy CTA on the right. Desktop-only — the
/// mobile build never imports this file.
class RecipeDetailDesktopScreen extends StatefulWidget {
  const RecipeDetailDesktopScreen({super.key, required this.slug});

  final String slug;

  @override
  State<RecipeDetailDesktopScreen> createState() =>
      _RecipeDetailDesktopScreenState();
}

class _RecipeDetailDesktopScreenState extends State<RecipeDetailDesktopScreen> {
  Recipe? _recipe;
  String? _recipeError;
  RecipeMatch? _match;
  String? _matchError;
  ...
  void _onBack() =>
      context.canPop() ? context.pop() : context.go(AppRoutes.recipes);
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                // Right column: info + sizes + buy CTA + ingredients.
                Expanded(
                  flex: 5,
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      Wrap(
                        ...
                        children: [
                          WBTag(
                            label: context.l10n.recipeDetailCookingTime(
                              recipe.cookingTimeMins,
                            ),
                          ),
...
/// Desktop buy CTA. Same copy and states as the mobile sticky bar, but inline
/// in the right info column instead of pinned to the viewport bottom.
