...
abstract final class MockData {
  ...
  static final categories = [
    ...
    Category(
      ...
      subcategories: [
        Subcategory(id: 'fast-food', label: 'Fast Food', imageUrl: WBImages.friedChicken, svgAsset: 'assets/categories/sub_burgers.svg'),
        Subcategory(id: 'local-cuisine', label: 'Local Cuisine', imageUrl: WBImages.jollof, svgAsset: 'assets/categories/sub_local.svg'),
        Subcategory(id: 'fine-dining', label: 'Fine Dining', imageUrl: WBImages.jollof, svgAsset: 'assets/categories/category_restaurants.svg'),
        Subcategory(id: 'grills-bbq', label: 'Grills & BBQ', imageUrl: WBImages.suya, svgAsset: 'assets/categories/sub_bbq.svg'),
        Subcategory(id: 'seafood', label: 'Seafood', imageUrl: WBImages.freshFish, svgAsset: 'assets/categories/sub_seafood.svg'),
        Subcategory(id: 'breakfast-brunch', label: 'Breakfast & Brunch', imageUrl: WBImages.eggs, svgAsset: 'assets/categories/category_restaurants.svg'),
        Subcategory(id: 'cafes', label: 'Cafés', imageUrl: WBImages.juice, svgAsset: 'assets/categories/category_restaurants.svg'),
    ...
    Category(
      ...
      subcategories: [
        ...
        Subcategory(id: 'vegetables', label: 'Vegetables', imageUrl: WBImages.vegetables, svgAsset: 'assets/categories/sub_bulk_veg.svg'),
    ...
    Category(
      ...
      subcategories: [
        ...
        Subcategory(id: 'water', label: 'Water', imageUrl: WBImages.water, svgAsset: 'assets/categories/sub_soft.svg'),
