...
/// Customer-facing basket. Holds both per-product items (legacy cart) and
/// recipe combos. Both halves load in parallel on init and the total bar
/// sums across them so checkout sees one number.
      ...
      builder: (_, recipeItems, _) {
        return ValueListenableBuilder<bool>(
          ...
          builder: (_, recipeLoading, _) {
            ...
            final cartIsEmpty =
                productLines.isEmpty && recipeItems.isEmpty;
                              ...
                              children: [
                                for (var i = 0; i < recipeItems.length; i++) ...[
                                  _RecipeCartRow(
                                    ...
                                    expanded: _expandedRecipeIds
                                        .contains(recipeItems[i].id),
                                    onToggle: () => setState(() {
                                    ...
                                    onRemove: () =>
                                        _confirmRemoveRecipe(recipeItems[i]),
                                  ),
                          ...
                          WBCard(
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  padding:
                                      const EdgeInsets.all(WBSpacing.md - 2),
                                  child: Row(
                                    children: [
                                      Container(
                                        width: 36,
