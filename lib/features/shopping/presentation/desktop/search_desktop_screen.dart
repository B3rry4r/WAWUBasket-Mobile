...
/// Desktop-web layout for the customer search surface. Mirrors
/// [SearchScreen]'s data loading, debounce, filter and error/empty handling
/// exactly — only the layout is re-flowed for a wide window: the search field
/// and filters sit in a centered column, and vendor / dish results render as
/// multi-column grids using the same cards as the mobile screen.
...
class _SearchDesktopScreenState extends State<SearchDesktopScreen> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ..._content(context, showVendors, showDishes),
                ],
              ),
            ),
          ),
  ...
  List<Widget> _content(
    ...
    if (!_searched) {
      return [
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 8),
                            GestureDetector(
                              onTap: () => setState(() => _recent = _recent
                                  .where((e) => e != r)
                                  .toList()),
                              child: const WBIcon(
                                WBIconName.close,
        ...
        _vendorGrid(_idleVendors.take(4).toList()),
      ];
    }
    ...
    if (_vendors.isEmpty && _products.isEmpty) {
      return [_hint('Nothing matched "${_query.text}".')];
    }
  ...
  Widget _vendorGrid(List<Vendor> vendors) {
    ...
    return GridView.builder(
      ...
      itemBuilder: (_, i) => _VendorRow(vendor: vendors[i]),
    );
  }
