...
/// Desktop-web layout for [VendorAnalyticsScreen]. Mirrors the mobile screen's
/// data loading ([VendorApi.analytics]), range selection, money/number
/// formatting, derived series (trend / heatmap / top sellers) and error/empty
/// handling exactly; only the layout is re-flowed into a dashboard with a page
/// header, a metrics row and a two-column chart grid. Pushed surface — wrapped
/// in [OperatorDesktopScaffold]. Mobile build untouched.
class VendorAnalyticsDesktopScreen extends StatefulWidget {
  const VendorAnalyticsDesktopScreen({super.key});

  @override
  State<VendorAnalyticsDesktopScreen> createState() =>
      _VendorAnalyticsDesktopScreenState();
}

int _int(dynamic v) => v is num ? v.toInt() : int.tryParse('${v ?? 0}') ?? 0;
...
class _VendorAnalyticsDesktopScreenState
    extends State<VendorAnalyticsDesktopScreen> {
  String _range = '7d';
  ...
  Widget _content(BuildContext context) {
    ...
    final ranges = _ranges(context);

    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        // Page header: back + title/subtitle on the left, range tags on right.
        Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    context.l10n.vendorAnalyticsTitle,
        ...
        // Metrics — 4-up row on desktop.
        Row(
          children: [
            _Metric(
                label: context.l10n.vendorAnalyticsOrders, value: orders),
            const SizedBox(width: WBSpacing.md),
            _Metric(
                label: context.l10n.vendorAnalyticsRevenue, value: revenue),
            const SizedBox(width: WBSpacing.md),
            _Metric(
                label: context.l10n.vendorAnalyticsAvgOrder, value: avgOrder),
            const SizedBox(width: WBSpacing.md),
            _Metric(
                label: context.l10n.vendorAnalyticsRating, value: rating),
          ],
        ),
        const SizedBox(height: WBSpacing.xl),
        // Two-column chart grid: sales trend + peak hours.
        IntrinsicHeight(
          child: Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
        ...
        const SizedBox(height: WBSpacing.xl),
        // Two-column: cancellations donut + top sellers.
        IntrinsicHeight(
          child: Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                _LegendRow(
                                  ...
                                  label:
                                      context.l10n.vendorAnalyticsOutOfStock,
                                  value: '42%',
                                ),
                                ...
                                _LegendRow(
                                  ...
                                  label:
                                      context.l10n.vendorAnalyticsWrongAddress,
                                  value: '23%',
                                ),
                                const SizedBox(height: 8),
                                _LegendRow(
                                  ...
                                  label: context
                                      .l10n.vendorAnalyticsCustomerChange,
                                  value: '20%',
                                ),
                                const SizedBox(height: 8),
                                _LegendRow(
                    ...
                    Row(
                      children: [
                        ...
                        GestureDetector(
                          onTap: () => wbShowSnack(
                            context,
                            context.l10n.vendorAnalyticsCsvStarted,
                          ),
                          child: Row(
                            children: [
...
/// widths stay legible; bucketing 24h into 8 reads more like
/// "morning/midday/dinner" than 24 thin columns.
