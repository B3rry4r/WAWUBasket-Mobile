...
/// Desktop-web layout for the vendor home dashboard.
///
...
/// [VendorHomeScreen]; only the layout is re-flowed for wide screens.
class VendorHomeDesktopScreen extends StatefulWidget {
  const VendorHomeDesktopScreen({super.key});

  @override
  State<VendorHomeDesktopScreen> createState() =>
      _VendorHomeDesktopScreenState();
}

class _VendorHomeDesktopScreenState extends State<VendorHomeDesktopScreen> {
  bool _open = true;
  String _rating = '';
  ...
  void _toggleOpen() {
    ...
    VendorApi.instance.updateSettings({'isOpen': newVal}).catchError((_) {
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      ...
      builder: (_, orders, _) {
        ...
        final todayRevenue = orders.fold<int>(0, (s, o) => s + o.total);
              ...
              child: WBMaxWidth(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                context.l10n.vendorDashboardSubtitle,
                    ...
                    // Two-column working area: orders left, "more" rail right.
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Expanded(
...
class _OrdersColumn extends StatelessWidget {
  const _OrdersColumn({required this.pending, required this.inProgress});
  final List<VendorOrder> pending;
  final List<VendorOrder> inProgress;
    ...
    return Column(
      ...
      children: [
        ...
        if (pending.isEmpty)
          ...
          _CardGrid(
            children: [
              for (final o in pending) _PendingCard(order: o),
            ],
          ),
        if (inProgress.isNotEmpty) ...[
          ...
          _CardGrid(
            children: [
              for (final o in inProgress) _InProgressCard(order: o),
            ],
          ),
        ],
      ],
...
/// Two-column responsive grid of equal-width cards.
      ...
      child: Column(
        ...
        children: [
                ...
                child: AnimatedContainer(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        open
                            ? context.l10n.vendorHomeOpen
                            : context.l10n.vendorHomeClosed,
                        style: WBTypography.caption.copyWith(
          ...
          Row(
            children: [
              _DarkStat(
                label: context.l10n.vendorAnalyticsOrders,
                value: '$ordersToday',
              ),
              const SizedBox(width: 10),
              ...
              const SizedBox(width: 10),
              _DarkStat(
                label: context.l10n.vendorAnalyticsRating,
                value: rating.isEmpty || rating == '0' || rating == '0.0'
                    ? 'New'
                    : rating,
              ),
            ],
