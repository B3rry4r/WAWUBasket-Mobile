...
/// Profile for one registered trader: identity, lifetime totals, recent
/// transactions and payouts, plus quick actions to record a new sale or
/// pay them out.
class AgentTraderDetailScreen extends StatelessWidget {
  const AgentTraderDetailScreen({super.key, required this.traderId});
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: WBButton(
                          ...
                          onPressed: () =>
                              context.push(AppRoutes.agentRecordTxn),
                        ),
                      ),
                      ...
                      Expanded(
                        child: WBButton(
                          ...
                          onPressed: () =>
                              context.push(AppRoutes.agentCashPayout),
                        ),
                      ),
                    ],
                  ),
                  ...
                  if (traderTxns.isEmpty)
                    ...
                    WBCard(
                      ...
                      child: Column(
                        children: [
                          for (var i = 0; i < traderTxns.length; i++) ...[
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          _fmtDate(traderTxns[i].recordedAt),
                                          style:
                                  ...
                                  Text(
                                    wbNaira(traderTxns[i].totalNaira),
                                    style: WBTypography.body.copyWith(
                  ...
                  if (traderPayouts.isEmpty)
                    ...
                    WBCard(
                      ...
                      child: Column(
                        children: [
                          for (var i = 0; i < traderPayouts.length; i++) ...[
                            Padding(
                              padding: const EdgeInsets.all(14),
                              child: Row(
                                children: [
                                  Expanded(
                                    child: Text(
                                      _fmtDate(traderPayouts[i].recordedAt),
                                      style: WBTypography.body.copyWith(
                                        fontSize: 14,
                                      ),
                                    ),
                                  ...
                                  Text(
                                    wbNaira(traderPayouts[i].amountNaira),
                                    style: WBTypography.body.copyWith(
                                      fontWeight: FontWeight.w700,
                                      fontSize: 14,
                                    ),
