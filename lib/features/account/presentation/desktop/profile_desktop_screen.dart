...
/// Desktop-web layout for the customer Account hub (the `profile` tab).
///
...
class _ProfileDesktopScreenState extends State<ProfileDesktopScreen> {
  ...
  Widget _buildGuest(BuildContext context) {
    return SingleChildScrollView(
      padding: const EdgeInsets.symmetric(vertical: WBSpacing.xxl),
      child: WBMaxWidth(
    ...
    return SingleChildScrollView(
      ...
      child: WBMaxWidth(
        ...
        child: Row(
          ...
          children: [
            // Master rail: profile summary + stats, sticky-feeling sidebar.
            SizedBox(
              width: 340,
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: ValueListenableBuilder<ProfileStats?>(
    ...
    return [
      ...
      AccountMenuSection(
        ...
        rows: [
          ...
          if (RoleController.instance.statusOf(AppRole.admin) ==
              RoleStatus.approved)
            AccountMenuRow(
