...
/// Desktop-web layout for the customer notifications screen. Mirrors the data
/// loading, grouping, read-state and navigation of [NotificationsScreen]
/// (mobile) but re-lays the content as a centered single column inside the
      ...
      child: ValueListenableBuilder(
        ...
        builder: (_, isGuest, _) {
          return WBMaxWidth(
            ...
            child: isGuest ? _buildGuest(context) : _buildSignedIn(context),
          );
        },
      ),
    );
