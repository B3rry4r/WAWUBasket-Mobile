...
/// Desktop-web layout for the customer's saved addresses.
///
/// PUSHED route — wrapped in [CustomerWebScaffold] for the shared top bar.
/// Re-lays the mobile vertical list into a centered, comfortable single-column
/// of the same address cards. Reuses [AddressController] + the [Address] model
/// and mirrors the mobile data loading, loading/empty handling, "set default"
/// flow and navigation precisely — this is layout only.
class SavedAddressesDesktopScreen extends StatefulWidget {
  const SavedAddressesDesktopScreen({super.key});

  @override
  State<SavedAddressesDesktopScreen> createState() =>
      _SavedAddressesDesktopScreenState();
}

class _SavedAddressesDesktopScreenState
    extends State<SavedAddressesDesktopScreen> {
  @override
  void initState() {
    super.initState();
