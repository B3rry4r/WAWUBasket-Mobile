...
/// Desktop-web layout for the language picker. Reuses the exact mobile
/// behaviour ([LocaleController.setLocale], the same language table and the
/// same l10n keys), re-laid-out as a centered settings column inside the
/// shared [CustomerWebScaffold]. Isolated from the mobile build.
class LanguageDesktopScreen extends StatefulWidget {
  const LanguageDesktopScreen({super.key});

  @override
  State<LanguageDesktopScreen> createState() => _LanguageDesktopScreenState();
}

class _LanguageDesktopScreenState extends State<LanguageDesktopScreen> {
