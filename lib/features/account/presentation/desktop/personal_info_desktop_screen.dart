...
/// Desktop-web layout for the customer personal-info editor.
///
/// PUSHED: wrapped in [CustomerWebScaffold] (the shared web chrome supplies the
/// top bar) with the form centered in a comfortable single column.
///
/// Re-lays the mobile [PersonalInfoScreen] only — reuses [ProfileController],
/// [ProfileApi] and [UploadService], and mirrors the mobile data loading,
/// avatar upload, validation, snackbars and navigation precisely.
class PersonalInfoDesktopScreen extends StatefulWidget {
  const PersonalInfoDesktopScreen({super.key});

  @override
  State<PersonalInfoDesktopScreen> createState() =>
      _PersonalInfoDesktopScreenState();
}

class _PersonalInfoDesktopScreenState extends State<PersonalInfoDesktopScreen> {
