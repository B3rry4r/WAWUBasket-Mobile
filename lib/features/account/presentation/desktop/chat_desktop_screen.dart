...
import '../screens/chat_screen.dart' show ChatContextKind;
...
/// Desktop-web layout for the customer chat thread. Mirrors [ChatScreen]'s
/// data loading, real-time WS handling, optimistic send, and message bubbles
/// exactly — only the chrome and layout differ: a centered single column with
/// the composer pinned at the bottom, inside the shared customer web scaffold.
