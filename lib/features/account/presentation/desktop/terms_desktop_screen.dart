...
/// Desktop-web layout for the Terms of Service document. Re-lays the mobile
/// [TermsScreen] copy into a centered, readable column inside the customer
/// web chrome. Isolated from the mobile build — the mobile screen is untouched.
class TermsDesktopScreen extends StatelessWidget {
  const TermsDesktopScreen({super.key});
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSection(
                ...
                'You agree to notify us immediately at support@wawu.africa if you suspect unauthorised '
              ...
              _buildSection(
                '13. Termination',
                'You may close your account at any time by contacting us at support@wawu.africa. '
