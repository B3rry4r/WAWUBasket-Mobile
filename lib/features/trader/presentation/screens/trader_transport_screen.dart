...
/// Post-a-load screen. The trader publishes a freight request; Batch E
/// wires the driver side that consumes it. State is kept minimal here
/// since the schema lives in the driver feature.
                  ...
                  child: Column(
                    children: [
                      for (var i = 0; i < _posted.length; i++) ...[
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '#${_posted[i].id} · ${_posted[i].weight} · ${_posted[i].bids} bids',
                                      style: WBTypography.caption.copyWith(
                                        color: WBColors.fgSecondary,
                                      ),
                                    ),
                        ...
                        if (i != _posted.length - 1) const WBDivider(),
                      ],
                    ],
                  ),
                ),
