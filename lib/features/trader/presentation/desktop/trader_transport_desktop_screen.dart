...
/// Desktop-web layout for [TraderTransportScreen]. Mirrors the mobile screen's
/// data loading (shared [TransportController]), the load-post form, money/weight
/// formatting, status logic, the driver-bid accept action and navigation exactly
/// — re-laid out as a two-column dashboard: the "Post a load" form on the left,
/// the trader's posted loads (and their bids) on the right, behind the persistent
/// operator sidebar. Desktop-only — the mobile build never imports this file.
class TraderTransportDesktopScreen extends StatefulWidget {
  const TraderTransportDesktopScreen({super.key});

  @override
  State<TraderTransportDesktopScreen> createState() =>
      _TraderTransportDesktopScreenState();
}

class _TraderTransportDesktopScreenState
    extends State<TraderTransportDesktopScreen> {
    ...
    return OperatorDesktopScaffold(
      ...
      child: ValueListenableBuilder(
        ...
        builder: (_, loads, _) {
          ...
          final shown = mine.isEmpty ? loads : mine;
          return WBMaxWidth(
            ...
            child: Column(
              ...
              children: [
                // Page header: back + title on the left, primary action right.
                Row(
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Transport requests', style: WBTypography.page),
                ...
                // Two-column: post form left, posted loads right.
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Expanded(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: WBStateField(
                                        ...
                                        value: _destinationState.isEmpty
                                            ? null
                                            : _destinationState,
                                        label: 'Dropoff state',
                                        onChanged: (s) => setState(() {
                                  ...
                                  children: [
                                    Expanded(
                                      child: WBCityField(
                                        ...
                                        value: _originCity.isEmpty
                                            ? null
                                            : _originCity,
                                        label: 'Pickup city',
                                        onChanged: (c) =>
                                            setState(() => _originCity = c),
                                      ),
                                    ),
                                    const SizedBox(width: 10),
                                    Expanded(
                                      child: WBCityField(
                                        ...
                                        value: _destinationCity.isEmpty
                                            ? null
                                            : _destinationCity,
                                        label: 'Dropoff city',
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (shown.isEmpty)
                            const WBEmptyState(
                              illustration:
                                  WBEmptyIllustration.noActiveLoads,
