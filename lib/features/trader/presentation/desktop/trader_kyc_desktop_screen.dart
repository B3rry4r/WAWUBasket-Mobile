...
/// Desktop-web layout for [TraderKycScreen]. Pre-auth: the operator isn't in
...
/// corridor selection, error handling and navigation that the mobile screen
/// uses, re-laid-out for wide windows.
class TraderKycDesktopScreen extends StatefulWidget {
  const TraderKycDesktopScreen({super.key});

  @override
  State<TraderKycDesktopScreen> createState() => _TraderKycDesktopScreenState();
}

class _TraderKycDesktopScreenState extends State<TraderKycDesktopScreen> {
